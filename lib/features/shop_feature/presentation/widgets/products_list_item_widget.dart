...
class ProductsListItem extends StatelessWidget {
  ...
  const ProductsListItem({super.key, required this.imagePath, required this.productTitle, required this.previousPrice, required this.currentPrice, required this.onTap});
