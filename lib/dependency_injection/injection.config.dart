...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt $initGetIt({
    ...
    gh.factory<_i9.ProductsRemoteDatasource>(
        () => _i9.ProductsRemoteDatasource());
    gh.factory<_i10.ProductsRepository>(() => _i11.ProductsRepositoryImpl(
        datasource: gh<_i9.ProductsRemoteDatasource>()));
    gh.factory<_i12.ProductsUsecase>(
        () => _i12.ProductsUsecase(repository: gh<_i10.ProductsRepository>()));
    return this;
  }
}
